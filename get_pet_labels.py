...
def get_pet_labels(image_dir):
    ...
    for idx in range(0, len(in_files), 1):
       ...
       if in_files[idx][0] != ".":
           ...
           # Processes each filename in the in_files list to extract the dog breed 
...
#               results_dic[pet_label] = [in_files[idx]]
    ...
    # Return the results_dic dictionary that has been created with this function
    return results_dic
